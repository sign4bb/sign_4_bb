...
if __name__ == '__main__':
    ...
    for _cf in cfs:
        ...
        #attacker.epsilon = 0.3
        #if IS_DEBUG_MODE:
        #   attacker.epsilon = np.inf

        # attacker = CheatAttack(max_loss_queries=4,
        #                        lr=0.3,
        #                        epsilon=0.3,
        #                        p='inf',
        #                        lb=dset.min_value,
        ...
        #c, h, w = get_dataset_shape(config['dset_name'])
        # attacker = BanditAttack(max_loss_queries=10,
        #                        lr=0.5,
        #                        epsilon=0.05,
        #                        p='inf',
        #                        lb=dset.min_value,
